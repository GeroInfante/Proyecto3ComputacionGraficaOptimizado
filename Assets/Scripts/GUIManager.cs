...
public class GUIManager : MonoBehaviour
{
    ...
    private void Start()
    {
        bServer.onClick.AddListener(delegate () { OnRoomButtonClicked(bServer,"Comedor"); });
        bVillage.onClick.AddListener(delegate () { OnRoomButtonClicked(bVillage, "Cocina"); });
        bDungeon.onClick.AddListener(delegate () { OnRoomButtonClicked(bDungeon, "Biblioteca"); });
        bCalabozo.onClick.AddListener(delegate () { OnRoomButtonClicked(bCalabozo, "Calabozo"); });
